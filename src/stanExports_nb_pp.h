...
public:
  ~model_nb_pp() {}
  model_nb_pp(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_nb_pp_namespace::model_nb_pp";
    // suppress unused var warning
    (void) function__;
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_nb_pp_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
            ...
            lp__);
      {
        ...
        lp_accum__.add((stan::math::normal_lpdf<false>(theta, THETA_EXT,
                          (SE_EXT / stan::math::sqrt(WEIGHT))) +
          stan::math::normal_lpdf<false>(theta, THETA_WEAK, SE_WEAK)));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_nb_pp_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
